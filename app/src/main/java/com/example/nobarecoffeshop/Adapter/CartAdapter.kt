...
import com.example.nobarecoffeshop.databinding.ViewholderCartBinding
...
class CartAdapter (
    ...
    override fun onBindViewHolder(holder: CartAdapter.Viewholder, position: Int) {
        ...
        holder.binding.feeEachItem.text="Rp${item.price}"
        holder.binding.totalEachItem.text="Rp${item.numberInCart * item.price}"
